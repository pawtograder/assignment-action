...
export type RetrieveAutograderRegressionTestsError =
...
export const retrieveAutograderRegressionTests = (
  ...
  adminServiceFetch<
    ...
    {}
  >({
    url: '/api/autograder/regression-tests',
    method: 'get',
    ...variables,
    signal
  })
...
export const createRegressionTestRun = (
  ...
  adminServiceFetch<
    ...
    CreateRegressionTestRunQueryParams,
    {}
  >({
...
export const getMeeting = (
  ...
  >({
    url: '/api/help-queue/help-request/{requestId}',
    method: 'get',
    ...variables,
    signal
  })
